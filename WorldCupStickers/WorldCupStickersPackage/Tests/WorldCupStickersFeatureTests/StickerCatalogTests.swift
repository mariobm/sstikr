...
struct StickerCatalogTests {
    ...
    func catalogCounts() throws {
        ...
        #expect(catalog.stickers.first?.imagePath == "stickers-new/00.jpg")
        #expect(catalog.stickers.contains { $0.displayCode == "URU 4" })
        #expect(catalog.stickers.contains { $0.displayCode == "NED 11" })
        #expect(catalog.stickers.contains { $0.id == "FWC-19" && $0.imagePath == "stickers-new/FWC/FWC-19.jpg" })
        #expect(catalog.stickers.contains { $0.id == "CC-14" && $0.imagePath == "stickers-new/CC/CC-14.jpg" })
