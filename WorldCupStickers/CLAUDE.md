...
- **Entitlements File**: `Config/WorldCupStickers.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/WorldCupStickers.entitlements`:
